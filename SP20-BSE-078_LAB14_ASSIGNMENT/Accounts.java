...
public class Accounts implements Serializable {
    ...
    public static void main(String[] args) {
        ...
        Accounts[] accounts = new Accounts[] {
                        new Accounts("1","Noor","18000"),
                        new Accounts("2","Zahra","44000"),
                        new Accounts("3","Nimra","27000"),
                        new Accounts("4","Sanabil","50000"),
                        new Accounts("5","Tooba","65000"),
                        new Accounts("6","Hamna","92000"),
                        new Accounts("7","Manal","40000"),
                        new Accounts("8","Abeer","22000"),
                        new Accounts("9","Asma","30000"),
                        new Accounts("10","Fatima","70000"), };
    ...
    public static ArrayList<Accounts> readObjectFromFile() {
        ...
        try {
            FileInputStream fileInputStream= new FileInputStream("C:\\Users\\Noor ul huda\\IdeaProjects\\Lab 14_078\\Accounts");
